...
async function generateTypes() {
  try {
    ...
    if (schemaData.definitions) {
      for (const [name, schema] of Object.entries(schemaData.definitions)) {
        ...
        try {
          ...
          console.warn(`⚠️  Failed to compile ${name}:`, compileError.message);
        }
    ...
    console.log('✅ Generated TypeScript types from backend schemas');
    console.log(`📁 Output: ${outputPath}`);
    console.log(`📊 Generated ${typeDefinitions.length} type definitions`);
    console.log('🔗 Frontend types are now synchronized with backend Pydantic models');
