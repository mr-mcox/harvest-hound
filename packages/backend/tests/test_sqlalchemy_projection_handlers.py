"""
Test projection handlers with SQLAlchemy-based view stores.

Testing integration between projection handlers and SQLAlchemy view stores
following the migration to SQLAlchemy Core per ADR-005.
"""
...
class TestInventoryProjectionHandlerWithSQLAlchemy:
    """Test InventoryProjectionHandler with SQLAlchemy view stores."""
...
class TestStoreProjectionHandlerWithSQLAlchemy:
    """Test StoreProjectionHandler with SQLAlchemy view stores."""
