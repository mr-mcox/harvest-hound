...
class BamlAsyncClient:
    ...
    async def NameDishes(self, ingredient: str,
        ...
        if 'on_tick' in baml_options:
            ...
            result = await self.__options.merge_options(baml_options).call_function_async(function_name="NameDishes", args={
...
class BamlStreamClient:
    ...
    def NameDishes(self, ingredient: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[typing.List["stream_types.Dish"], typing.List["types.Dish"]]:
        ctx, result = self.__options.merge_options(baml_options).create_async_stream(function_name="NameDishes", args={
            "ingredient": ingredient,
        })
        return baml_py.BamlStream[typing.List["stream_types.Dish"], typing.List["types.Dish"]](
          result,
...
class BamlHttpRequestClient:
    ...
    async def NameDishes(self, ingredient: str,
        ...
        result = await self.__options.merge_options(baml_options).create_http_request_async(function_name="NameDishes", args={
            "ingredient": ingredient,
        }, mode="request")
        return result
